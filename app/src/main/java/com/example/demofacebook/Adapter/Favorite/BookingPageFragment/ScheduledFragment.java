...
public class ScheduledFragment extends Fragment {
    ...
    private List<Order> getOrderData() {
        ...
        myList.add(new Order(1, "Studio 1", dateChange, "PENDING", 100000, 4, "", "Service 1"));
        myList.add(new Order(2, "Studio 2", dateChange, "PENDING", 100000, 4, "", "Service 1"));
        myList.add(new Order(3, "Studio 3", dateChange, "PENDING", 100000, 4, "", "Service 1"));
        myList.add(new Order(4, "Studio 4", dateChange, "PENDING", 100000, 4, "", "Service 1"));
        myList.add(new Order(5, "Studio 5", dateChange, "PENDING", 100000, 4, "", "Service 1"));
        return myList;
    }
